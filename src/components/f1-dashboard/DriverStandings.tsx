            ...
            <tbody>
              {standings.map((standing, index) => (
                <tr key={index} className="hover:bg-gray-100">
                  ...
                  {classificationType === 'driver' ? (
                    <>
                      <td className="py-2 px-4 border-b border-gray-200">{standing.driver}</td>
                      <td className="py-2 px-4 border-b border-gray-200">{standing.nationality}</td>
                      <td className="py-2 px-4 border-b border-gray-200">{standing.car}</td>
                    </>
                  ) : (
                    <>
